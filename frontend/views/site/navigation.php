...
use yii\bootstrap5\NavBar;
 ...
 NavBar::begin([
    'options' => [
        'class' => 'navbar navbar-expand-lg navbar-light bg-white pe-4 ',
    ],
...
{ /*array_push($menuItems, 
    ['label' => $lang->languageNames, 'url' => ['/site/index']]
...
*/
    ...
    /*
      array_push($menuItems, Html::a('Search', [actionLanguage(), ['class' => 'btn btn-success']]));
    */
/*
    Html::a($lang->languageNames, ['search-function', 'Name' => $this->$sname], ['class' => 'btn btn-success'])
   
    
<?= Html::a('Search', ['search-function', 'Name' => $this->$sname], ['class' => 'btn btn-success']) ?>
    array_push($menuItems, Html::submitButton($lang->languageNames, [ $this->context->changeLanguage($lang->id)]) );*/
}
